...
#line 57
 await testRunner.WhenAsync(string.Format("Send the request with an invalid image (no characters) using baseUrl \"{0}\" and ap" +
                            "iKey \"{1}\"", baseUrl, apiKey), ((string)(null)), table26, "When ");
#line hidden
#line 60
...
#line hidden
            ...
            else
            {
                ...
                table27.AddRow(new string[] {
                            "NoCharacters.png"});
#line 66
 await testRunner.WhenAsync(string.Format("Send a request using an invalid API key \"{0}\" with baseUrl \"{1}\"", apiKey, baseUrl), ((string)(null)), table27, "When ");
#line hidden
#line 69
...
#line hidden
            ...
            else
            {
                ...
                table28.AddRow(new string[] {
                            "PNGImage.png"});
#line 74
 await testRunner.WhenAsync(string.Format("Send a request without API key \"{0}\" with baseUrl \"{1}\"", apiKey, baseUrl), ((string)(null)), table28, "When ");
#line hidden
#line 77
 await testRunner.ThenAsync("The request is rejected and returns a 401 Unauthorized error", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table29.AddRow(new string[] {
                            "PNGImage.png"});
#line 82
 await testRunner.WhenAsync(string.Format("Send the request with baseUrl \"{0}\" and correct API key \"{1}\" as input", baseUrl, apiKey), ((string)(null)), table29, "When ");
#line hidden
#line 85
...
#line 90
 await testRunner.WhenAsync(string.Format("Send a request with input as an image in a supported format (JPEG, PNG, BMP, PDF," +
                            ...
                            "all the identified character strings", baseUrl, apiKey), ((string)(null)), table30, "When ");
#line hidden
...
#line 97
 await testRunner.AndAsync(string.Format("Send a request with input as an image in an unsupported format (Ex: GIF, WEBP, SV" +
                            "G, etc.) using baseUrl \"{0}\" and apiKey \"{1}\" and verify the 400 error returned", baseUrl, apiKey), ((string)(null)), table31, "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line 106
 await testRunner.WhenAsync(string.Format("Send a request to the OCR service under normal system load using baseUrl \"{0}\" an" +
                            "d apiKey \"{1}\" and verify the median response time", baseUrl, apiKey), ((string)(null)), table32, "When ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line 113
 await testRunner.WhenAsync(string.Format("OCR service is deployed to all the cloud regions using baseUrl \"{0}\" and apiKey \"" +
                            "{1}\"", baseUrl, apiKey), ((string)(null)), table33, "When ");
#line hidden
#line 116
