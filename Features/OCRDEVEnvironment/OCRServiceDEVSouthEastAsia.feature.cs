...
namespace QuantumServicesAPI.Features.OCRDEVEnvironment
{
    using Reqnroll;
    using System;
    using System.Linq;
    ...
    public partial class OCRServiceDEVEnvironmentSoutheastAsiaRegionFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/OCRDEVEnvironment", "OCR Service – DEV Environment (Southeast Asia Region)", "A short summary of the feature", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line 8
 await testRunner.WhenAsync("Send the request with a correct image as input", ((string)(null)), table18, "When ");
#line hidden
#line 11
...
#line hidden
            ...
            else
            {
                ...
                table19.AddRow(new string[] {
                            ...
                            "69df563662e74ba8811e47a9a61ccf7b"});
#line 17
 await testRunner.WhenAsync("Send a request with input as an image in PNG format with size more than 256kb", ((string)(null)), table19, "When ");
#line hidden
#line 20
...
#line hidden
                ...
                table20.AddRow(new string[] {
                            ...
                            "69df563662e74ba8811e47a9a61ccf7b"});
#line 21
 await testRunner.WhenAsync("Send a request with input as an image in PNG format with size less than 256kb", ((string)(null)), table20, "When ");
#line hidden
#line 24
...
#line hidden
            ...
            else
            {
                ...
                table21.AddRow(new string[] {
                            ...
                            "69df563662e74ba8811e47a9a61ccf7b"});
#line 30
 await testRunner.WhenAsync("Send the request with a blurry image as input", ((string)(null)), table21, "When ");
#line hidden
#line 33
...
#line hidden
            ...
            else
            {
                ...
                table22.AddRow(new string[] {
                            ...
                            "69df563662e74ba8811e47a9a61ccf7b"});
#line 39
 await testRunner.WhenAsync("Send the request with an invalid image (no characters)", ((string)(null)), table22, "When ");
#line hidden
#line 42
...
#line hidden
            ...
            else
            {
                ...
                table23.AddRow(new string[] {
                            ...
                            "1234567890"});
#line 48
 await testRunner.WhenAsync("Send a request to the South-East Asia region using an invalid API key", ((string)(null)), table23, "When ");
#line hidden
#line 51
...
#line hidden
            ...
            else
            {
                ...
                table24.AddRow(new string[] {
                            ...
                            ""});
#line 56
 await testRunner.WhenAsync("Send a request to the SouthEastAsia region without an API key", ((string)(null)), table24, "When ");
#line hidden
#line 59
 await testRunner.ThenAsync("The request is rejected and returns a 401 Unauthorized error", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table25.AddRow(new string[] {
                            ...
                            "69df563662e74ba8811e47a9a61ccf7b"});
#line 64
 await testRunner.WhenAsync("Send the request with a correct APIkey as input", ((string)(null)), table25, "When ");
#line hidden
#line 67
...
#line 72
 await testRunner.WhenAsync("Send a request with input as an image in a supported format (JPEG, PNG, BMP, PDF," +
                        " TIFF) and verify the response and list of all the identified character strings", ((string)(null)), table26, "When ");
#line hidden
...
#line 79
 await testRunner.AndAsync("Send a request with input as an image in an unsupported format (Ex: GIF, WEBP, SV" +
                        "G, etc.) and verify the 400 error returned", ((string)(null)), table27, "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line 88
 await testRunner.WhenAsync("Send a request to the OCR service under normal system load and verify the median " +
                        "response time", ((string)(null)), table28, "When ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
            ...
            else
            {
                ...
                table29.AddRow(new string[] {
                            ...
                            "69df563662e74ba8811e47a9a61ccf7b"});
#line 95
 await testRunner.WhenAsync("OCR service is deployed to the SouthEast Asia cloud region", ((string)(null)), table29, "When ");
#line hidden
#line 98
 await testRunner.AndAsync("OCR service should be operational in the SouthEast Asia cloud region", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
