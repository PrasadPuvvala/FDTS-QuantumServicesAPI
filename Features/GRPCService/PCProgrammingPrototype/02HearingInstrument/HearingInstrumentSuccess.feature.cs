...
using Reqnroll;
namespace QuantumServicesAPI.Features.GRPCService.PCProgrammingPrototype._02HearingInstrument
{
    ...
    public partial class HearingInstrumentSuccessFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/GRPCService/PCProgrammingPrototype/02HearingInstrument", "HearingInstrument Success", "A short summary of the feature", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line 8
 await testRunner.WhenAsync("Send a request to the DetectBySerialNumber API with a valid serial number that ma" +
                        "tches an existing device", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 9
...
#line 44
 await testRunner.WhenAsync("Send a request to the BootDevice API with any boot type when reconnect flag is se" +
                        "t to True and verify the response", ((string)(null)), table8, "When ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line 125
 await testRunner.WhenAsync("Send a request to the RHI Battery Type API with a valid battery type to write to " +
                        "the connected RHI device", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 126
