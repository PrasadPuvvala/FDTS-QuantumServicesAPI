...
@HearingInstrument
Scenario: 06Test Case ID 1809118: [Avalon Service] Verify ConnectToDevice API Returns 'HearingInstrumentCreationFailed' When Device Model Is Not Found in Product Configuration Database
...
@HearingInstrument
Scenario: 07Test Case ID 1809119: [Avalon Service] Verify ConnectToDevice API Returns 'AuthenticationFailed' When Device Has Been Powered for More Than 3 Minutes
...
#@HearingInstrument
#Scenario: 08Test Case 1810796: [Avalon Service] Verify BootDevice API Boots Device with selected Boot mode without reconnecting when reconnect flag is False
#
...
#	| BootType    | SerialNumber |
#	| ServiceMode | 2400801519   |
#	| DfuMode     |              |
#	| DspRunning  |              |
