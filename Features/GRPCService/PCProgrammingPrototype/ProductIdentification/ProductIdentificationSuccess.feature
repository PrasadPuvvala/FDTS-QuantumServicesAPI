...
@ProductIdentification
Scenario: 10Test Case ID 1810706: [Avalon Service] [HI Automation] Verify GNOSRegistrationData API Returns Data in XML Format Successfully
...
@ProductIdentification
Scenario: 12Test Case ID 1809280: [Avalon Service] Verify OptionsForDevice API Returns Current Device Options Successfully
...
@ProductIdentification
Scenario: 14Test Case ID 1809282: [Avalon Service] Verify PrivateLabelCode API Returns Current Private Label Code Successfully
